...
import { getCsrfToken, login } from '../services/authService'; // login 함수 가정
...
function MainPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // 백엔드 인증 (authService의 login 함수 사용)
      const data = await login(idToken, csrfToken); // login 함수가 정의되어 있다고 가정
